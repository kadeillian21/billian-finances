...
import { faArrowAltCircleUp, faArrowAltCircleDown, faArrowPointer, faHamburger, faBell, faX, faPlus, faEllipsisVertical } from '@fortawesome/free-solid-svg-icons'
        ...
        <div className="relative isolate overflow-hidden pt-16">
          ...
          <header className="pb-4 pt-6 sm:pb-6">
            <div className="mx-auto flex max-w-7xl flex-wrap items-center gap-6 px-4 sm:flex-nowrap sm:px-6 lg:px-8">
              ...
              >
                <FontAwesomeIcon icon={faPlus} className="-ml-1.5 h-5 w-5" aria-hidden="true" />
                New invoice
              </a>
            </div>
          </header>
